	...
	<div id="video">
        ...
        <div id="fullpage" class="fullpage-default">
            ...
            <div class="section animated-row" data-section="slide01">
                    ...
                    <h3>Vomiting in Children</h3>
					<form action="f-vomit.php" method="post">
						...
						<div class="container">
						  <div class="row">
							...
							<div class="col-sm">
								<input type="radio" name="accomp[]" value="Eating certain food">
								<label for="male">Eating certain food</label>
							</div>
							<div class="col-sm">
								<input type="radio" name="accomp[]" value="Travel or Motion">
								<label for="female">Travel or Motion</label><br>
							</div>
							<div class="col-sm">
							</div>
						  </div>
						...
						<div class="container">
						  <div class="row">
							...
							<div class="col-sm">
								<input type="checkbox" name="accomp[]" value="Abdominal bloating or swelling">
								<label for="male">Abdominal bloating or swelling</label><br>
								...
								<input type="checkbox" name="accomp[]" value="Abdominal pain,discomfort or cramps">
								<label for="male">Abdominal pain,discomfort or cramps</label><br>
							</div>
							<div class="col-sm">
								...
								<input type="checkbox" name="accomp[]" value="Wheezing">
								<label for="male">Wheezing</label><br>
								<input type="checkbox" name="accomp[]" value="Swelling or tingling of lips, face and tongue">
								<label for="male">Swelling or tingling of lips, face and tongue</label><br>
							</div>
							<div class="col-sm">
							</div>
						  </div>
