	...
	<div id="video">
        ...
        <div id="fullpage" class="fullpage-default">
            ...
            <div class="section animated-row" data-section="slide01">
                    ...
                    <h3>Diarrhea in Children</h3>
					<form action="f-diarrhea.php" method="post">
						<h5>Problem is</h5>
						...
						<input type="checkbox" name="accomp[]" value="Hallucinations">
						<label for="male">Hallucinations</label><br>
						<input type="checkbox" name="accomp[]" value="Stomach growling or rumbling">
						<label for="male">Stomach growling or rumbling</label><br>
