            ...
            <div class="section animated-row" data-section="slide01">
                <div class="section-inner">
                    <div class="welcome-box">
                        ...
                        <h4 class="welcome-title animate" data-animate="fadeInUp">Children's Health Prediction</h4>
                        <p class="animate" data-animate="fadeInUp">Would you like to check the possible health condition of your children based on their symptoms</p>
						<a href="major.html"><button class="btn">Proceed</button></a>
                    </div>
                </div>
            </div>		
		</div>	
